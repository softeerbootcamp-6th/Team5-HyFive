...
public interface DispatchLocationProvider {
    default List<DispatchLocation> getAll() {
        throw new UnsupportedOperationException("getAll() not supported");
    }

    default List<DispatchLocation> getByCondition(Condition condition) {
        throw new UnsupportedOperationException("getByCondition() not supported");
    }
}